...
async function getConversations(id_nguoidung) {
    try {
        ...
        const query = `SELECT conversation.id, conversation.userId1, conversation.userId2, nguoidung.id_nguoidung, nguoidung.ten, nguoidung.url_avatar FROM conversation LEFT JOIN nguoidung ON (conversation.userId1 = nguoidung.id_nguoidung AND conversation.userId2 = ${id_nguoidung}) OR(conversation.userId2 = nguoidung.id_nguoidung AND conversation.userId1 = ${id_nguoidung}) WHERE conversation.userId1 = ${id_nguoidung} OR conversation.userId2 = ${id_nguoidung} `;
